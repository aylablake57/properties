...
<body style="background-color: #ffffff; margin: 0; padding: 0;">
    <div style="width:100%;padding:20px;background-color:#ffffff;">
        ...
        <div style="width:95%;margin:auto;background-color:#f9f9f9;padding:20px;border-radius:5px;">
            <h4>Dear Valued Member,</h4>
            <p>You have a new meesage from customer regarding your property. The details are given below:</p>
            <table style="border-collapse:collapse;width:100%;margin-top:20px; margin-bottom:50px;">
                ...
                <tr>
                    <td style="border: 1px solid #ddd; padding: 8px; width: 25%;">Customer Type</td>
                    <td style="border: 1px solid #ddd; padding: 8px; width: 25%;">{{ $mailData['role'] }}</td>
                </tr>
                <tr>
            ...
            <footer style="width:95%;margin:auto;margin-top: 30px;padding-top: 20px;padding-bottom: 20px;padding-right: 20px;padding-left: 20px;border-top: 1px solid #ddd;text-align: center;background-color:#ffffff;">
